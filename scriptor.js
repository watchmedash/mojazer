...
function setupWatchButtons() {
    document.querySelectorAll(".watch-btn").forEach((button) => {
        button.addEventListener("click", (event) => {
            ...
            showModal(movieId, movieOverview);
        });
    });
}
...
function showModal(movieId, movieOverview) {
    // Set the movie overview in the modal
    document.querySelector("#modal-description").textContent = movieOverview;
    ...
    // Display the modal
    document.querySelector("#movie-modal").style.display = "block";
}

document.querySelector("#close-modal").addEventListener("click", () => {
    document.querySelector("#movie-modal").style.display = "none";
    // Clear the player src so it stops the video when closing the modal
